import { IData, ITableSmall, ITableLarge, ITablePreloader, ISortData } from "./setTable-reducer";
...
export const setSortDataAC = (data: Array<IData>): ISortData => ({ type: SET_SORT_DATA, data });